...
Think of it like an RSS reader, but for WACZ web archives. Anyone with the [Nostr Web Archiver](https://github.com/) Chrome extension can archive a web page — the archive gets uploaded to a Blossom server and announced on Nostr. Narchives is the reading client for those archives.
