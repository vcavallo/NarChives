...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = rootProject.file("narchives-release.jks")
            storePassword = "narchives2026"
            keyAlias = "narchives"
            keyPassword = "narchives2026"
        }
    }
    ...
    buildTypes {
        ...
        release {
            isMinifyEnabled = false // disabled for now — enable later with proper proguard rules
    ...
    applicationVariants.all {
        ...
        variant.outputs.all {
            ...
            output.outputFileName = "NarChives-${variant.versionName}-${variant.buildType.name}.apk"
        }
    }
}
